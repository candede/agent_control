...
describe("route policy declarations", () => {
  it("covers every application route and requires CSRF on unsafe authenticated methods", () => {
    ...
    const expected = [
      ...
      "GET /capabilities", "POST /capabilities/:id/probe", "PUT /capabilities/:id/configuration",
      ...
      "POST /agents/refresh-jobs", "POST /agents/:id/refresh-jobs", "GET /agents/refresh-jobs", "GET /agents/refresh-jobs/:id", "POST /agents/refresh-jobs/:id/resume", "GET /agents/snapshots", "GET /agents/export.csv", "POST /agents/export.csv",
      ...
      "POST /inventory/refresh-jobs", "GET /inventory/refresh-jobs", "GET /inventory/refresh-jobs/:id", "POST /inventory/refresh-jobs/:id/resume", "GET /inventory/snapshots", "GET /inventory/resources", "GET /inventory/resources/:nativeId/related", "GET /inventory/quarantine-selection", "GET /inventory/export.csv",
